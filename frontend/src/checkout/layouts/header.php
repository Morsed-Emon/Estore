   ...
   <div class="container">
        <div class="row mt-2 mb-2">
            <div class="col-md-12 col-xs-12">
                <h1>
                <a href="http://localhost/Project1/frontend/src/index.html" class="navbar-brand"><img src="assets/product-images/logo1.png" width="100px"></a>
                </h1>
            </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0"">
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/Project1/frontend/src/index.php">Explore Categories & Brand <span class="sr-only">(current)</span></a>
                </li>
            </ul>
